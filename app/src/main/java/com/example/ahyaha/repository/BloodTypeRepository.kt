...
object BloodTypeRepository {
    ...
    fun getAllBloodTypes(): List<BloodType> {
        ...
        return listOf(
            ...
            BloodType("2", "AB", "+" , Picture= R.drawable.img_1),
            BloodType("3", "B", "+", Picture= R.drawable.img_2),
            BloodType("4", "A", "+", Picture= R.drawable.img_3),
            BloodType("5", "O", "-", Picture= R.drawable.img_4),
            BloodType("6", "AB", "-", Picture= R.drawable.img_5),
            BloodType("7", "B", "-", Picture= R.drawable.img_6),
            BloodType("8", "A", "-", Picture= R.drawable.img_7)
        )
    }
}